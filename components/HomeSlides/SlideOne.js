                ...
                <div className="hero-content text-neutral-content block">
                    <div className="font-bold mb-20">
                        <div className="grid grid-cols-2 gap-2">
                            <div className="grid col-span-2 lg:col-span-1 content-center">
